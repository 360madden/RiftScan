...
Created UTC: `2026-05-07T16:43:11Z`
App version: `riftscan-ai-workflow-packet-v1.0.0`
...
| Ledger authorizes movement | `False` |
...
2. Start from this AI Workflow Packet, then inspect the Discovery Ledger report and summary.
...
10. The next useful offline slice is a safe candidate-ledger consumer or stale-artifact age warning; do not pivot into live testing without explicit authorization.

## AI resume prompt

```text
Resume RiftScan in offline AI workflow mode. Read handoffs/current/ai-workflow/AI_WORKFLOW_PACKET.md, then the Discovery Ledger artifacts. Do not touch live RIFT, focus preflight, capture, process attach/memory reads, movement/input, RiftReader commands, offset validation, or /reloadui unless the user explicitly authorizes live work.
```
