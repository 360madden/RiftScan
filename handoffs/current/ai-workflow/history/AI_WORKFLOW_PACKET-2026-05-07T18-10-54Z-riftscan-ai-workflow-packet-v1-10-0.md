...
Created UTC: `2026-05-07T18:10:54Z`
...
```text
status: CHANGED
previous_created_utc: 2026-05-07T18:03:05Z
...
| Field | Before | After |
|---|---|---|
| `app_version` | `riftscan-ai-workflow-packet-v1.9.0` | `riftscan-ai-workflow-packet-v1.10.0` |
...
```json
{
  "archive_stem": "2026-05-07T18-03-05Z-riftscan-ai-workflow-packet-v1-9-0",
  "artifacts": {
    "report": "handoffs/current/ai-workflow/history/AI_WORKFLOW_PACKET-2026-05-07T18-03-05Z-riftscan-ai-workflow-packet-v1-9-0.md",
    "summary": "handoffs/current/ai-workflow/history/ai-workflow-summary-2026-05-07T18-03-05Z-riftscan-ai-workflow-packet-v1-9-0.json"
  },
  ...
  "source_created_utc": "2026-05-07T18:03:05Z",
  "status": "ARCHIVED"
}
```
...
```json
{
  "entry": {
    ...
    "indexed_utc": "2026-05-07T18:10:54Z",
