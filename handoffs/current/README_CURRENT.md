...
- AI Workflow Packet is a compact offline agent resume packet with previous-packet diffing documented in `docs/ai-workflow-packet-schema.md`: `python tools/riftscan_ai_workflow_packet.py --self-test`, `python tools/riftscan_ai_workflow_packet.py`, and `.\scripts\run-riftscan-ai-workflow-packet.cmd --strict-exit-code`.
