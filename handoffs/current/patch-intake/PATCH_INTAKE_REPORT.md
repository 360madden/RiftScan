...
Created UTC: `2026-05-04T21:47:53Z`
...
```json
{
  ...
  "apply_prompt": {
    "approved": true,
    "mode": "gui_apply_prompt"
  },
  "apply_result": {
    "app_version": "riftscan-patch-intake-v1.1.0",
    "applier_path": ".riftscan-local/patch-intake/staging/patch-intake-push-verify-v1-1-1-compact-20260504b/apply_patch_intake_push_verify_v1_1_1_compact.py",
    "apply_exit_code": 0,
    "apply_stderr": "",
    "apply_stdout": "PASS_PATCH_INTAKE_PUSH_VERIFY_V1_1_1\n",
    "code": "PASS_APPLIED",
    "compile_exit_code": 0,
    "compile_stderr": "",
    "compile_stdout": "",
    "created_utc": "2026-05-04T21:47:47Z",
    "from_version": "riftscan-patch-intake-v1.1.0",
    "git_status_short": " M handoffs/current/patch-intake/PATCH_INTAKE_REPORT.md\n M handoffs/current/patch-intake/last-validation-result.json\n M handoffs/current/patch-intake/patch-intake-log.jsonl\n",
    "issues": [],
    "manifest": {
      "applier": "apply_patch_intake_push_verify_v1_1_1_compact.py",
      "commit": {
      ...
      "created_utc": "2026-05-04T22:12:00Z",
      "from_version": "riftscan-patch-intake-v1.1.0",
      "magic": "RIFTSCAN_CLIPBOARD_PATCH_V1",
      "package_id": "patch-intake-push-verify-v1-1-1-compact-20260504b",
    ...
    "mode": "apply",
    "package_id": "patch-intake-push-verify-v1-1-1-compact-20260504b",
    "payload_sha256": "07810b4a03bbdb4e4022058c098e17607aa4475dbc8e8c6e3cca3d80cc8277c6",
    "payload_type": "python_applier_base64_gzip",
    "post_apply_checks": [
      {
        "check": "py_compile_patch_intake",
        "code": "PASS_CHECK",
        "exit_code": 0,
        "status": "pass",
        "stderr": "",
      ...
      {
        "check": "git_status_check",
        "code": "PASS_CHECK",
        "exit_code": 0,
        "status": "pass",
        "stderr": "",
        "stdout": " M handoffs/current/patch-intake/PATCH_INTAKE_REPORT.md\n M handoffs/current/patch-intake/last-dry-run-result.json\n M handoffs/current/patch-intake/last-validation-result.json\n M handoffs/current/patch-intake/patch-intake-log.jsonl\n M scripts/riftscan-patch-intake.cmd\n M tools/riftscan_patch_intake_app.py\n?? tools/__pycache__/\n"
      }
    ],
  ...
  "code": "PASS_PROCESSED",
  "created_utc": "2026-05-04T21:47:46Z",
  "dry_run_result": {
    "app_version": "riftscan-patch-intake-v1.1.0",
    "applier_path": ".riftscan-local/patch-intake/staging/patch-intake-push-verify-v1-1-1-compact-20260504b/apply_patch_intake_push_verify_v1_1_1_compact.py",
    "code": "PASS_DRY_RUN",
  ...
  "stage": "write_last_process_result",
  "status": "pass",
  "target_file": "tools/riftscan_patch_intake_app.py",
  "validation_result": {
    "app_version": "riftscan-patch-intake-v1.1.0",
    "code": "PASS_VALID_PATCH",
    "created_utc": "2026-05-04T21:47:46Z",
    "from_version": "riftscan-patch-intake-v1.1.0",
    "git_status_short": " M handoffs/current/patch-intake/PATCH_INTAKE_REPORT.md\n M handoffs/current/patch-intake/last-validation-result.json\n M handoffs/current/patch-intake/patch-intake-log.jsonl\n",
    "issues": [],
