...
```text
head: 85471bd0b698ba6de55176562a0d4243c90b2615
```
...
```text
 ...
 M handoffs/current/ai-workflow/AI_WORKFLOW_HISTORY_INDEX_REPORT.md
 M handoffs/current/ai-workflow/AI_WORKFLOW_PACKET.md
 M handoffs/current/ai-workflow/ai-workflow-history-index-summary.json
 ...
 M handoffs/current/discovery-ledger/candidate_ledger.jsonl
 ...
 M tools/riftscan_discovery_ledger.py
?? handoffs/current/ai-workflow/history/AI_WORKFLOW_PACKET-2026-05-07T18-11-22Z-riftscan-ai-workflow-packet-v1-10-0.md
?? handoffs/current/ai-workflow/history/AI_WORKFLOW_PACKET-2026-05-09T01-50-21Z-riftscan-ai-workflow-packet-v1-11-0.md
?? handoffs/current/ai-workflow/history/ai-workflow-summary-2026-05-07T18-11-22Z-riftscan-ai-workflow-packet-v1-10-0.json
?? handoffs/current/ai-workflow/history/ai-workflow-summary-2026-05-09T01-50-21Z-riftscan-ai-workflow-packet-v1-11-0.json
...
```text
85471bd Add one-hour milestone resume handoff
a6b4300 Add offline AI workflow resume handoff
...
```json
{
  ...
  "created_utc": "2026-05-13T17:40:59Z",
  "display_status": "PASS",
  "failed_check_count": 0,
  "failed_checks": [],
  "git": {
    ...
    "head": "85471bd0b698ba6de55176562a0d4243c90b2615",
    "log_oneline_5": "85471bd Add one-hour milestone resume handoff\na6b4300 Add offline AI workflow resume handoff\nfced91d Generate AI packet history report\n60a8e5b Add AI packet history index view\naad6f11 Validate full AI packet history index",
